...
const Login = (props) => {
  ...
  const submitHandler = e => {
    ...
    if (email !== 'email@mail' || password !== 'password') {
  ...
  return (
    <Container>
      <Row className="justify-content-md-center">
        <Col md="auto" className='loginCard' >
          <h3>Bienvenido</h3>
          <div className="card">
            ...
            <form onSubmit={submitHandler}>
              <div className="field">
                ...
                <input autocomplete="off" id="logemail" placeholder="email@mail" class="input-field" name="email" type="email" />
              </div>
              <div className="field">
                <svg className="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
